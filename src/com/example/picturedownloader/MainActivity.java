package com.example.picturedownloader;

import java.io.File;

import com.example.picturedownloader.PicrureLoaderResult.LoaderResult;
...
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<PicrureLoaderResult> {
	...
	private static String picture = "logo.png";
		...
		openClickListener = new View.OnClickListener() {
			public void onClick(View v) {
				Uri contentUri = FileProvider.getUriForFile(getApplicationContext(),
						"com.example.picturedownloader.fileprovider", // formatting
						new File(getFilesDir(), picture));
